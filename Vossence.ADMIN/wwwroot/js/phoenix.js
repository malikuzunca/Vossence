(function (global, factory) {
    ...
    const reportsDetailsChartInit = () => {
        ...
        const tooltipFormatter = (params, dateFormatter = 'MMM DD') => {
          ...
          <h6 class="text-body-tertiary"><span class="fas fa-circle me-1 fs-10" style="color:${el.color
                    }"></span>
        ...
        if (window.List) {
            ...
            if (lists.length) {
                lists.forEach(el => {
                    ...
                    const updateListControls = () => {
                        listInfo &&
                            (listInfo.innerHTML = `Toplam ${totalItem} Kayit Bulunuyor. ${list.i} ile ${numberOfcurrentItems} Arasi Kayitlar Listeleniyor`);
                        ...
                        if (isSearching) {
                            ...
                            listInfo &&
                                (listInfo.innerHTML = `${list.matchingItems.length === 0 ? 0 : list.i
                                    } to ${list.matchingItems.length === 0 ? 0 : numberOfcurrentItems
                                    } <span class='text-body-tertiary'> Items of </span>${list.matchingItems.length
                                    }`);
                        }
    ...
    const searchInit = () => {
        //const Selectors = {
        //    SEARCH_DISMISS: '[data-bs-dismiss="search1"]',
        //    DROPDOWN_TOGGLE: '[data-bs-toggle="dropdown1"]',
        //    DROPDOWN_MENU: '.dropdown-menu1',
        //    SEARCH_BOX: '.search-box1',
        //    SEARCH_INPUT: '.search-input1',
        //    SEARCH_TOGGLE: '[data-bs-toggle="search1"]'
        //};
    ...
    const tinymceInit = () => {
        ...
        `,
                        ...
                        toolbar: ["styleselect fontselect fontsizeselect font-family forecolor backcolor undo redo cut copy paste pastetext bold italic link image alignleft aligncenter alignright alignjustify bold italic underline strikethrough subscript superscript bullist numlist outdent indent searchreplace selectall link unlink anchor image table hr fullscreen charmap blockquote subscript superscript advlist autolink lists charmap print preview code"],
                        setup: editor => {
                            editor.on('focus', () => {
